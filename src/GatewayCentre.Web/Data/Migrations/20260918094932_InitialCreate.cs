...
namespace GatewayCentre.Web.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Floor = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    StartingPriceRs = table.Column<decimal>(type: "TEXT", nullable: false),
                    FeaturesText = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventType = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlockedDates_Halls_HallId",
                        column: x => x.HallId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuoteRequests_Halls_HallId",
                        column: x => x.HallId,
                        principalTable: "Halls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_QuoteRequests_Packages_PackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedDates_Date_HallId",
                table: "BlockedDates",
                columns: new[] { "Date", "HallId" });

            migrationBuilder.CreateIndex(
                name: "IX_BlockedDates_HallId",
                table: "BlockedDates",
                column: "HallId");

            migrationBuilder.CreateIndex(
                name: "IX_QuoteRequests_HallId",
                table: "QuoteRequests",
                column: "HallId");

            migrationBuilder.CreateIndex(
                name: "IX_QuoteRequests_PackageId",
                table: "QuoteRequests",
                column: "PackageId");
        }
